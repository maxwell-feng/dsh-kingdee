...
> Verified against deepseek-harness **0.1.2-alpha.5** (latest `master`; `0.1.2-alpha.4` → `0.1.2-alpha.5` no DSH seam changes affecting this plugin).
...
| `kingdee_delete_draft` | Delete draft (暂存) records | `formId`, `ids[]` |
