 ...
 * K3Cloud surface.
 */
import { businessHeaders, buildLoginPayload, validateConfig } from "./auth.js";
import { assertSuccess, KdError, toKdError } from "./errors.js";
import { extractKdsvcCookie, joinUrl, parseEnvelope } from "./envelope.js";
...
export class KdClient {
    ...
    async login() {
        ...
        if ((this.cfg.authMode ?? 'user') !== 'user')
            return undefined;
